        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasData(
                    ...
                    new Product { Id = 16, Name = "Dyson V15 Detect", Description = "Беспроводной пылесос с лазерной подсветкой", Price = 75000m, Stock = 5, CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
                    new Product { Id = 17, Name = "Xbox Series X", Description = "Самая быстрая и мощная консоль Xbox", Price = 50000m, Stock = 10, CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
                );
            });
