        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasData(
                    ...
                    new Product { Id = 17, Name = "Xbox Series X", Description = "Самая мощная консоль Xbox в истории", Price = 50000m, Stock = 12, CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
                );
            });
